...
3) =brew bundle= を使って必要なパッケージを一気にインストール
   #+BEGIN_SRC sh
   curl https://gist.githubusercontent.com/nagae/bcc31992f4a864cd002a1f91ee9c275d/raw/94bd7d3e65b214242ef4dca9f95bba23bcb74708/Brewfile -o ~/Brewfile
   brew bundle
   #+END_SRC
   上述でインストールされる [[https://gist.github.com/nagae/bcc31992f4a864cd002a1f91ee9c275d][パッケージ一覧]] 
